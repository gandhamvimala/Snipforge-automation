...
- Name: tools.spec.js >> BUG-003: Process button should show clear disabled state before upload
- Location: src/tests/generated/scripts/tools.spec.js:86:1
...
Locator: getByText('Upload a video first')
Expected: visible
Error: strict mode violation: getByText('Upload a video first') resolved to 23 elements:
    1) <button disabled id="sz-run" class="run-btn" onclick="runShorten()">Upload a video first</button> aka locator('#sz-run')
    2) <button disabled id="tr-run" class="run-btn" onclick="runTrim()">Upload a video first</button> aka locator('#tr-run')
    3) <button disabled id="mt-run" class="run-btn" onclick="runMultiTrim()">Upload a video first</button> aka locator('#mt-run')
    4) <button disabled id="sp-run" class="run-btn" onclick="runSpeed()">Upload a video first</button> aka getByRole('button', { name: 'Upload a video first' })
    5) <button disabled id="ro-run" class="run-btn" onclick="runRotate()">Upload a video first</button> aka locator('#ro-run')
    6) <button disabled id="cr-run" class="run-btn" onclick="runCrop()">Upload a video first</button> aka locator('#cr-run')
    7) <button disabled id="wm-run" class="run-btn" onclick="runWatermarkImage()">Upload a video first</button> aka locator('#wm-run')
    8) <button disabled id="cm-run" class="run-btn" onclick="runCompress()">Upload a video first</button> aka locator('#cm-run')
    9) <button disabled id="vl-run" class="run-btn" onclick="runVolume()">Upload a video first</button> aka locator('#vl-run')
    10) <button disabled id="au-run" class="run-btn" onclick="runAudio()">Upload a video first</button> aka locator('#au-run')
    ...

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Upload a video first')
    ...
    - generic [ref=e349]:
      - generic [ref=e350]:
        - generic [ref=e351]:
          - generic [ref=e352]: ⚡
          - text: Speed Control
        - generic [ref=e353]: Speed up or slow down your video
      ...
      - generic [ref=e359]:
        - heading "Speed" [level=4] [ref=e360]
        - generic [ref=e361]:
          - generic [ref=e362] [cursor=pointer]:
            - generic [ref=e363]: 0.5×
            - generic [ref=e364]: Slow Mo
          - generic [ref=e365] [cursor=pointer]:
            - generic [ref=e366]: 0.75×
            - generic [ref=e367]: Slower
          - generic [ref=e368] [cursor=pointer]:
            - generic [ref=e369]: 1.5×
            - generic [ref=e370]: Fast
          - generic [ref=e371] [cursor=pointer]:
            - generic [ref=e372]: 2×
            - generic [ref=e373]: Double
          - generic [ref=e374] [cursor=pointer]:
            - generic [ref=e375]: 3×
            - generic [ref=e376]: Triple
        - generic [ref=e377]:
          - generic [ref=e378]: Custom Speed
          - slider [ref=e379] [cursor=pointer]: "1.5"
          - generic [ref=e380]: 1.50×
      - button "Upload a video first" [disabled] [ref=e381]
```
