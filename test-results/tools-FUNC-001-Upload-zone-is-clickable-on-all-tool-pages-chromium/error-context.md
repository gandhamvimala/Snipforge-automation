...
- Name: tools.spec.js >> FUNC-001: Upload zone is clickable on all tool pages
- Location: src/tests/generated/scripts/tools.spec.js:122:1
...
Call log:
  ...
  - waiting for locator('[class*="drop"],[class*="upload"],[class*="zone"]').first()
    19 × locator resolved to <div id="sz-dropzone" class="upload-zone">…</div>
